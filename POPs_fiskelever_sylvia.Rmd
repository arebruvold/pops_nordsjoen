...
cleaned_data <- raw_data %>% 
  ...
  # update two values found to be incorrectly entered during data exploration
...
We have deviation from normality and p-values should be interpreted with caution.
