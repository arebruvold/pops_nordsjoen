---
title: "Six groups of persistent organic pollutants show varying temporal trends in three North Sea gadoid fish species: Data treatment and statistical analysis"
output:
...
From previous studies it is known that effect of these variables will differ between species, owing to their distinct physiology and feeding habits. Hence, a model was fitted to each species since comparisons between different fish species were not a priority. Known confounders are fish age or proxies such as fish length and fish weight as well as liver weight, liver fat content and hepatosomatic or liver somatic index.
...
Deviation from normality is observed and p-values should be interpreted with caution. Bimodality observed for HCH appeared could not be linked to sampling location.
